...
import { DEMO_DISCOVER_SKILLS } from "@/constants/discover-demo";
    ...
    <View className="gap-5">
      ...
      <View className="gap-1.5">
        ...
        <View className="flex-row items-center h-14 rounded-xl px-4 gap-2 bg-surface-input dark:bg-surface-input-dark">
          ...
          <TextInput
            ...
            onBlur={() =>
              props.setDisplayNameError(validateDisplayName(props.displayName))
            }
      ...
      <View className="gap-1.5">
        ...
        <View className="flex-row items-center h-14 rounded-xl px-4 gap-2 bg-surface-input dark:bg-surface-input-dark">
          ...
          <TextInput
            ...
            onBlur={() =>
              props.setUsernameError(validateUsername(props.preferredUsername))
            }
            autoCapitalize="none"
      ...
      <View className="gap-1.5">
        ...
        <View className="flex-row items-center h-14 rounded-xl px-4 gap-2 bg-surface-input dark:bg-surface-input-dark">
          ...
          <TextInput
            ...
            onBlur={() =>
              props.setPasswordError(validatePassword(props.password))
            }
        ...
        <View className="flex-row items-center h-14 rounded-xl px-4 gap-2 bg-surface-input dark:bg-surface-input-dark">
          ...
          <TextInput
            ...
            onChangeText={(text) => {
              ...
              props.setConfirmPasswordError(
                getConfirmPasswordError(props.password, text),
              );
            }}
          ...
          >
            <Ionicons
              name={
                props.showConfirmPassword ? "eye-outline" : "eye-off-outline"
              }
              size={20}
              color={props.theme.textMuted}
            />
      ...
      <View className="gap-1.5 pt-2">
        ...
        <SkillsCloud
          ...
          skills={props.selectedSubjects}
          variant={props.role}
        />

        {props.isLoadingSkills ? (
          <View className="h-12 items-center justify-center">
            <ActivityIndicator color={props.theme.primary} />
          </View>
        ) : (
          <View className="flex-row flex-wrap gap-2 mt-1">
            {selectableSkills.map((skill) => {
              const isSelected = props.selectedSubjects.includes(skill);
              ...
              return (
                <Pressable
                  ...
                  onPress={() => {
                    const nextSelection = isSelected
                      ? props.selectedSubjects.filter(
                          (subject) => subject !== skill,
                        )
                      : [...props.selectedSubjects, skill];

                    props.setSelectedSubjects(nextSelection);
                ...
                >
                  <Text
                    className="text-sm font-semibold"
                    style={{
                      color: isSelected ? "#FFFFFF" : props.theme.textPrimary,
                    }}
                  >
                    {skill}
                  </Text>
      ...
      <View className="gap-1.5">
        ...
        >
          <View
            ...
            style={{
              backgroundColor: props.terms
                ? props.theme.primary
                : "transparent",
              borderColor: props.terms
                ? props.theme.primary
      ...
      >
        ...
        >
          ...
          <RegisterForm
            ...
            isLoadingSkills={skillsQuery.isLoading && !skillsQuery.data}
            theme={theme}
          />
        </ScrollView>
      </KeyboardAvoidingView>
