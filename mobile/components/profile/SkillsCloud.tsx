...
interface SkillsCloudProps {
  ...
  onEdit?: () => void; 
  // TODO: [Navigation] Wire this up to a "View All" Bottom Sheet later
  onViewAll?: () => void;
}

export function SkillsCloud({ title, skills, variant, onEdit, onViewAll }: SkillsCloudProps) {
        ...
        {skills.length === 0 ? (
          ...
          <>
            ...
            {hiddenCount > 0 && (
              ...
              >
                <Text className="text-sm font-bold text-gray-700">+{hiddenCount} more</Text>
              </TouchableOpacity>
            )}
          </>
        )}
