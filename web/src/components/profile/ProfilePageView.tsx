...
/**
 * Returns initial letters for avatar fallback.
 */
...
/**
 * Formats ISO date range for availability section.
 */
...
/**
 * Renders a profile page section that can be reused by authorized and guest routes.
 */
