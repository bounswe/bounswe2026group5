    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="accounts.ProfileExpertise",
                to="accounts.expertisefield",
            ),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["profile", "start_at"], name="availabilit_profile_06c146_idx"
                    ),
                    models.Index(
                        fields=["is_booked", "start_at"], name="availabilit_is_book_7387a7_idx"
                    ),
                ],
                "constraints": [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["profile", "expertise_field"], name="profile_exp_profile_1924ae_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="profileexpertise",
            constraint=models.UniqueConstraint(
                fields=("profile", "expertise_field"), name="uniq_profile_expertise"
            ),
        ),
        migrations.AddConstraint(
            model_name="profileexpertise",
            constraint=models.CheckConstraint(
                condition=models.Q(("proficiency_level__gte", 1), ("proficiency_level__lte", 5)),
        ...
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(fields=["mentorship_mode"], name="profiles_mentors_c5f0f6_idx"),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(
